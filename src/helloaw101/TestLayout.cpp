...
TestLayout::TestLayout(TestModel *model) : m_model{model} {
    ...
    m_parameterStorage->addChild<Parameter>(this, "OSC I Tune (st)", Parameter::SliderPack{10, 1, 128}, [this](int value) {
        m_model->m_synth.setIncI(value);
    });
    m_parameterStorage->addChild<Parameter>(this, "OSC II Tune (st)", Parameter::SliderPack{1, 1, 82}, [this](int value) {
        m_model->m_synth.setIncII(value);
    });
    m_parameterStorage->addChild<Parameter>(this, "Envelope Attack Time (ms)", Parameter::SliderPack{250, 0, 5000}, [this](int value) {
        m_model->m_synth.setAttack(value);
    });
    m_parameterStorage->addChild<Parameter>(this, "Envelope Release Time (ms)", Parameter::SliderPack{250, 0, 5000}, [this](int value) {
    ...
    m_parameterStorage->addChild<Parameter>(this, "OSC I Feedback (%)", Parameter::SliderPack{1, 0, 100}, [this](int value) {
        m_model->m_synth.setOSCIFeedback(value);
    });
    m_parameterStorage->addChild<Parameter>(this, "OSC II Feedback (%)", Parameter::SliderPack{1, 0, 100}, [this](int value) {
